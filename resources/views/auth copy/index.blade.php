...
@section('content')
    ...
    <section class="blur-background w-full flex-col items-center justify-center">
        ...
        <div class="bg-white px-3 py-2">
            ...
            <div class="flex gap-3">
                ...
                <a id="" class="signupLink cursor-pointer font-[600] text-red-900 underline hover:no-underline"
        ...
        <div id="" class="loginSection h-fit  flex-col gap-2 rounded-sm bg-white px-3 py-2 shadow-lg">
            <div>
                <form action="{{ route('auth.login') }}" method="post" class="flex flex-col gap-2">
                    @csrf
        ...
        {{-- Sign up section --}}
        <div id="" class="signupSection hidden h-fit  flex-col gap-2 rounded-sm bg-white px-3 pb-2 shadow-lg">
            <div>
                <form method="POST" class="flex signupForm flex-col gap-2" action="{{ route('auth.register') }}">
    @csrf
    <div class="login-field flex flex-col gap-1">
    ...
    <div class="login-field flex flex-col gap-1">
        <label class="font-[500]" for="email">Email</label>
        <input title="Eg: mark@yokomail.com" class="input" type="email" name="email" placeholder="Enter your Email">
        <span class="text-[12px] font-[200] text-red-700">
            @error('email')
                {{ $message }}
            @enderror
    ...
    <div class="flex flex-col gap-1">
        <label class="font-[500]" for="password">Password</label>
        <div class="flex items-center">
            <input class="signupPassword passMain input" id="signupPassword" type="password" name="password" placeholder="Enter Password">
            <input type="checkbox" class="toggleSignupPassword ml-2" onclick="togglePasswordVisibility('signup')">
    ...
    <div class="flex flex-col gap-1">
        <label class="font-[500]" for="confirmPassword">Confirm Password</label>
        <div class="flex items-center">
            <input class="signupPassword confirmPassword input" id="confirmPassword" type="password" name="confirm_password" placeholder="Confirm Password">
        </div>
        <span class="text-[12px] font-[200] text-red-700">
    ...
    <button class="hover:red-alt-800 w-full rounded-md bg-red-alt-700 py-2 text-center uppercase text-white submit" type="submit">Sign Up</button>
</form>
